...
class TestHelper {
    ...
    static let keynRequest = KeynRequest(accountID: TestHelper.userID, accountIDs: nil, browserTab: 0, challenge: "tnlOysO9SoL_PAXiEuqgSNZdnZ_BfJ_ri_9UnF4B5nM", password: "[jh6eAX)og7A#nJ1:YDSrD6#61cf${\"A", passwordSuccessfullyChanged: false, siteID: TestHelper.sampleSite.id, siteName: TestHelper.sampleSite.name, newSiteName: "new-\(TestHelper.sampleSite.name)", siteURL: TestHelper.sampleSite.url, notes: "Important note", type: .add, relyingPartyId: "test.com", algorithms: nil, username: TestHelper.username, sentTimestamp: TimeInterval(), count: 0, orderKey: nil, organisationName: nil, askToChange: nil, sessionID: TestHelper.sessionID, accounts: nil) // Challenge is SHA256({"challenge":"3rEAfh7LQeqrLBiQjZM5284v54xIWEWV-tGOulwoDTE","clientExtensions":{},"hashAlgorithm":"SHA-256","origin":"http://localhost:9005","type":"webauthn.get"})
