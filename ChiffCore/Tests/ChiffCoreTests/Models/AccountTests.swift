...
class AccountTests: XCTestCase {
    ...
    func testInitDoesntThrow() {
        XCTAssertNoThrow(try UserAccount(username: TestHelper.username, sites: [TestHelper.sampleSite], password: nil, webauthn: nil, notes: nil, askToChange: nil))
        XCTAssertNoThrow(try UserAccount(username: TestHelper.username + "2", sites: [TestHelper.sampleSite], password: "password", webauthn: nil, notes: nil, askToChange: nil))
    }
    
    func testNextPassword() {
        let site = TestHelper.sampleSite
        do {
            var account = try UserAccount(username: TestHelper.username, sites: [site], password: nil, webauthn: nil, notes: nil, askToChange: nil)
    ...
    func testOneTimePasswordToken() {
        let site = TestHelper.sampleSite
        do {
            let account = try UserAccount(username: TestHelper.username, sites: [site], password: nil, webauthn: nil, notes: nil, askToChange: nil)
    ...
    func testSetOtpDoesntThrow() {
        ...
        do {
            var account = try UserAccount(username: TestHelper.username, sites: [TestHelper.sampleSite], password: nil, webauthn: nil, notes: nil, askToChange: nil)
    ...
    func testDelete() {
        ...
        do {
            let account = try UserAccount(username: TestHelper.username, sites: [TestHelper.sampleSite], password: nil, webauthn: nil, notes: nil, askToChange: nil)
    ...
    func testPasswordV1_1() {
        let expectation = XCTestExpectation(description: "Finish testPassword")
        do {
            let account = try UserAccount(username: TestHelper.username, sites: [TestHelper.sampleSiteV1_1], password: nil, webauthn: nil, notes: nil, askToChange: nil)
            account.password(reason: "Testing", type: .ifNeeded).done { (password) in
    ...
    func testDeleteAll() {
        XCTAssertNoThrow(try UserAccount(username: TestHelper.username, sites: [TestHelper.sampleSite], password: nil, webauthn: nil, notes: nil, askToChange: nil))
        XCTAssertNoThrow(try UserAccount(username: TestHelper.username + "2", sites: [TestHelper.sampleSite], password: nil, webauthn: nil, notes: nil, askToChange: nil))
